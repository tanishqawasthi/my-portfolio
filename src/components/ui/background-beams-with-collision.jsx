...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-screen bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-900 dark:to-black relative flex items-center w-full justify-center overflow-hidden ",
