      ...
      content: (
        <div>
          <p
            ...
            Joined Brane Enterprises as an Associate Solutions Leader (SDE 1)
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Worked as a full Stack Development Intern at WeSourceU.
          </p>
          <p
            className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
      ...
      content: (
        <div>
          <p
            ...
            Worked as a Web Development Intern at WeSourceU
          </p>
          <div className="mb-8">
            <div
